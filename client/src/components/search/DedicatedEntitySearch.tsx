...
import { searchLookup } from '../../api/lookup'
import type { LookupEntity, LookupResult } from '../../types/lookup'
      ...
      <div className="mb-2 flex items-center justify-between gap-3">
        <div>
          ...
          <p className={helperClass}>
            Ignores dashboard date filters and searches the full dataset.
          </p>
        </div>
