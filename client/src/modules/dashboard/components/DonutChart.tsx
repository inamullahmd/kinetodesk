...
import { formatCurrency, formatLabel, formatNumber, toNumber } from '../../../shared/utils/format'
...
export default function DonutChart({
  ...
  if (!chartData.length) {
    return (
      <div
        className={`rounded-2xl border px-4 py-8 text-center text-sm ${isDark
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <div
                    className={`mt-0.5 text-xs font-medium ${isDark ? 'text-slate-300' : 'text-slate-600'
                      }`}
                  >
                    {metric === 'revenue'
              ...
              <div className="text-right">
                <div
                  className={`font-data text-sm font-semibold ${isDark ? 'text-white' : 'text-slate-900'
                    }`}
                >
                ...
                <div
                  className={`text-[10px] uppercase tracking-[0.14em] ${isDark ? 'text-slate-500' : 'text-slate-400'
                    }`}
                >
                  share
                </div>
